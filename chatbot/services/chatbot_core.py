...
from chatbot.services.tts_service import generate_voice_response_by_poly
...
async def process_text_message(user_text: str, sid: str):
    ...
    b64_wav = await generate_voice_response_by_poly(reply_text)  # 16kHz mono WAV -> base64
    return {
        "user_text": user_text,
        "bot_text": reply_text,
        "bot_audio": b64_wav,
